// TestDialog.h : interface of the CTestDialog class
//
/////////////////////////////////////////////////////////////////////////////
...
class CTestDialog :
	...
	public CDialogResize<CTestDialog>
{
protected:
	typedef CTestDialog thisClass;
	typedef CDialogImpl<CTestDialog> baseClass;
	typedef CDialogResize<CTestDialog> resizeClass;
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	BEGIN_DLGRESIZE_MAP(thisClass)
		...
		DLGRESIZE_CONTROL(IDC_BTN_EXECUTE, (DLSZ_MOVE_X))
