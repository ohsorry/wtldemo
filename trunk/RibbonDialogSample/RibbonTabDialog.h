#if !defined(AFX_RIBBONTABDIALOG_H__A65B6092_3600_4f9f_A9DA_8B444D0B8CE1__INCLUDED_)
#define AFX_RIBBONTABDIALOG_H__A65B6092_3600_4f9f_A9DA_8B444D0B8CE1__INCLUDED_
...
/*	Using the Code:
	...
	1. Add RibbonTabDialog.h to project, and add:
		#include "RibbonTabDialog.h"

	2. Derive a dialog box from CRibbonDialogImpl, instead of CDialogImpl

	3. Add the following to -beginning- of your message map:
	...
	4. Add tabs and sub-tabs during dialog initialization (OnInitDialog). For example:
		...
		AddSubTab(ID_TAB1SUBTAB1, IDI_ICON1); // using optional icon
		AddSubTab(ID_TAB1SUBTAB2); // no icon for the second sub tab
	
	5. Handle WM_COMMAND messages, which will indicate changes in sub-tabs. For example,
	   add these to your message map:
	   ...
	   In the WM_COMMAND message, the low-order word of wParam will be the string resource
	   ID of the selected sub-tab. The high-order word of wParam will be 0.

    6. Do whatever you want when the tab/sub-tab changes. And most importantly, enjoy! :D
	...
	To your project configuration properties, add the following to Linker/Input:
...
#ifndef	__ATLAPP_H__
	#error RibbonTabDialog.h requires atlapp.h to be included first
#endif

#ifndef	__ATLWIN_H__
	#error RibbonTabDialog.h requires atlwin.h to be included first
#endif
...
// --
// Colors (RGB) - blue theme
#define TABBACKGROUNDCOLOR			RGB(205,224,240)	// You'll see this on XP, and on Vista when Aero is off
...
private: // ---------------------------------------------------------------------------
	...
	// See: "How To Converting Colors Between RGB and HLS"
...
#endif // !defined(AFX_RIBBONTABDIALOG_H__A65B6092_3600_4f9f_A9DA_8B444D0B8CE1__INCLUDED_)
